...
import {
  ...
  useFormControl
} from "./chunk-RTQUHXCN.js";
import {
  Fade_default,
  IconButton_default
} from "./chunk-XTMKBAHR.js";
import {
  useThemeProps
} from "./chunk-GHAJPUC6.js";
import {
  shouldForwardProp,
  useRtl
} from "./chunk-PVDQNZFR.js";
import {
  styled_default
...
var useFieldState = (params) => {
  ...
  const localizedDigits = React9.useMemo(() => getLocalizedDigits(utils), [utils]);
  const sectionsValueBoundaries = React9.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React9.useCallback((value, fallbackSections = null) => fieldValueManager.getSectionsFromValue(utils, value, fallbackSections, (date) => buildSectionsFromFormat({
    utils,
    timezone,
  ...
  const parsedSelectedSections = React9.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
...
var useFieldV7TextField = (params) => {
  ...
  const sectionListRef = React11.useRef(null);
  ...
  const sectionBoundaries = React11.useMemo(() => {
    ...
    return state.sections.map((section, index) => {
      ...
      return {
        ...
        content: {
          ...
          [parseInt(React11.version, 10) >= 17 ? "enterKeyHint" : "enterkeyhint"]: isEditable ? "next" : void 0,
  ...
  const valueStr = React11.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  React11.useEffect(() => {
...
var useFieldV6TextField = (params) => {
  const isRtl = useRtl();
  const focusTimeoutRef = React12.useRef();
  const selectionSyncTimeoutRef = React12.useRef();
  const {
    forwardedProps: {
      onFocus,
      onClick,
  ...
  const sections = React12.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React12.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React12.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React12.useEffect(() => {
...
var _excluded11 = ["PaperComponent", "popperPlacement", "ownerState", "children", "paperSlotProps", "paperClasses", "onPaperClick", "onPaperTouchStart"];
...
//# sourceMappingURL=chunk-SJEENOMT.js.map
