...
var Tooltip = React85.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React85.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime98.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime99.jsxs)(React85.Fragment, {
    children: [React85.cloneElement(children, childrenProps), (0, import_jsx_runtime98.jsx)(PopperComponent, _extends({
